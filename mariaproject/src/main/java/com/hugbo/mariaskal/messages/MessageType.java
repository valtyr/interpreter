...
public enum MessageType {
    ...
    ERROR_RECEIVED("ERROR_RECEIVED"), START_ROUND("START_ROUND"), START_TURN("START_TURN"), END_TURN("END_TURN"),
    CORRECT("CORRECT"), SKIP("SKIP"), PUBLISH_CARDGROUP("PUBLISH_CARDGROUP");
